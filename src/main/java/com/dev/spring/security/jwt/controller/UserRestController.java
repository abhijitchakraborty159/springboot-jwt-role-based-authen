...
import com.dev.spring.security.jwt.entities.UserRequest;
import com.dev.spring.security.jwt.entities.UserResponse;
...
public class UserRestController {
	...
	public ResponseEntity<String> test(){
		return ResponseEntity.ok("test with tester ");
	}
    ...
    public Optional<User> getUserDetails(@PathVariable("username") String userName){
